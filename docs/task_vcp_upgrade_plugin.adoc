...
* Si sta eseguendo l'aggiornamento a Element Plug-in per vCenter Server 5.1 o 5.0.
* Si sta eseguendo l'aggiornamento a 8.0 o 7.0 HTML5 vSphere Web Client.



IMPORTANT: Element Plug-in per vCenter 5.0 e versioni successive non è compatibile con vCenter Server 6.7 e 6.5.
...
+
image::vcp_remote_plugin_icons_home_page.png[Mostra il punto di estensione del plug-in dopo un aggiornamento o un'installazione riusciti per Element Plug-in 5.0 o versioni successive]
...
+
image::vcp_shortcuts_page_accessing_plugin.png[Mostra i punti di estensione del plug-in dopo un aggiornamento o un'installazione riusciti per Element Plug-in 4.10 o versioni precedenti]
